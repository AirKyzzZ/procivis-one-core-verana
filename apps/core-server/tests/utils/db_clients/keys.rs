...
pub fn ecdsa_testing_params() -> TestingKeyParams {
    TestingKeyParams {
        ...
        // private key (unencrypted): [56,151,105,61,235,90,246,249,183,236,90,157,106,176,145,114,36,199,115,51,234,102,21,254,34,219,38,210,7,172,169,157]
...
pub fn eddsa_testing_params() -> TestingKeyParams {
    TestingKeyParams {
        ...
        // bytes: [74,4,73,201,147,238,139,201,79,45,112,196,152,35,15,38,190,141,58,19,101,184,37,84,210,101,19,245,37,171,239,95]
        public_key: Some(
            hex!("4a0449c993ee8bc94f2d70c498230f26be8d3a1365b82554d26513f525abef5f").to_vec(),
        ),

        // private key (unencrypted): [198,42,58,194,72,37,250,120,202,196,254,252,111,170,50,115,237,210,60,246,89,235,38,17,208,42,2,2,229,233,217,178,74,4,73,201,147,238,139,201,79,45,112,196,152,35,15,38,190,141,58,19,101,184,37,84,210,101,19,245,37,171,239,95]
        key_reference: Some(
