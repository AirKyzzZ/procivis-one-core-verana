...
impl TryFrom<WalletInstanceAttestation> for ActiveModel {
    type Error = DataLayerError;
    fn try_from(wallet_unit_attestation: WalletInstanceAttestation) -> Result<Self, Self::Error> {
...
impl From<Model> for WalletInstanceAttestation {
