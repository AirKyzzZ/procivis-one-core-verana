...
use one_core::model::wallet_instance::{
    WalletInstance, WalletInstanceStatus as ModelWalletUnitStatus,
};
...
#[sea_orm(table_name = "wallet_instance")]
pub struct Model {
...
pub enum Relation {
    ...
    Organisation,
    #[sea_orm(has_many = "super::wallet_instance_attested_key::Entity")]
...
#[from(one_core::model::wallet_instance::WalletInstanceOs)]
#[into(one_core::model::wallet_instance::WalletInstanceOs)]
...
#[derive(Clone, Debug, Eq, PartialEq, EnumIter, DeriveActiveEnum, Into, From, Deserialize)]
#[from(one_core::model::wallet_instance::WalletInstanceStatus)]
#[into(one_core::model::wallet_instance::WalletInstanceStatus)]
#[sea_orm(rs_type = "String", db_type = "String(StringLen::None)")]
...
#[derive(Clone, Debug, Eq, PartialEq, EnumIter, DeriveActiveEnum, Into, From, Deserialize)]
#[from(one_core::model::wallet_instance::WalletProviderType)]
#[into(one_core::model::wallet_instance::WalletProviderType)]
#[sea_orm(rs_type = "String", db_type = "String(StringLen::None)")]
...
impl TryFrom<WalletInstance> for ActiveModel {
    type Error = DataLayerError;
    fn try_from(wallet_unit: WalletInstance) -> Result<Self, Self::Error> {
